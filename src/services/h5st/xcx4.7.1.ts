...
@Injectable()
export class Xcx471 extends BaseH5st {
  protected readonly logger = new Logger(Xcx471.name);
  constructor(
  ...
  init(h5stInitConfig: H5stInitConfig) {
    super.init(h5stInitConfig, H5stAlgoConfigCollection[H5stVersion['xcx4.7.1']]);
  }
